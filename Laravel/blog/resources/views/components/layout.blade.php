    ...
    <nav class="md:flex md:justify-between md:items-center">
        ...
        <div class="mt-8 md:mt-0 flex flex-row:space-evenly items-center">
            @auth
               <x-dropdown>
                   <x-slot name="trigger">
                       <button class="mr-4">Welcome, {{ auth()->user()->name }}</button>
                   </x-slot>
                   @admin
                   <x-dropdown-item href="/admin/posts/create" :active="request()->is('admin/posts/create')">New post</x-dropdown-item>
                   <x-dropdown-item href="/admin/posts" :active="request()->is('admin/posts/create')">All posts</x-dropdown-item>
                    @endadmin
               </x-dropdown>
            ...
            <div class="relative inline-block mx-auto lg:bg-gray-200 rounded-full">
                ...
                <form method="POST" action="/newsletter" class="lg:flex text-sm">
                    ...
                    <div class="lg:py-3 lg:px-5 flex items-center">
                        ...
                        <input id="email-subscribe" name="email" type="text" placeholder="Your email address"
